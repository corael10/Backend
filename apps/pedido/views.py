...
class PedidoDetalle(APIView):
    ...
    def delete(self, request, pk, format=None):
        pedido = self.get_object(pk)
        idpedido = pedido.id
        print('id pedodp ',pedido.estatus)
...
class MarcaPedido(APIView):
    ...
    def put(self, request, pk, format=None):
        pedido = self.get_object(pk)
        print(pedido)
        print(pedido.cliente_id)
        serializer = PedidoSerializer(pedido)
        updateCliente = Cliente.objects.get(id= pedido.cliente_id) # Actualizamos el saldo en la tabla de Cliente
        updateCliente.saldo = updateCliente.saldo + pedido.total
        updateCliente.save() #Guardamos la actualizacion con el nuevo saldo

        updateEmpleado = Empleado.objects.get(id= pedido.empleado_id) # Actualizamos el saldo en la tabla de Empleado
...
class GetpedidoList(APIView):
    ...
    def get(self, request, format=None):
        ...
        #print('datos enviados de consulta ',serializer.data)
        return Response(serializer.data)
    ...
    def post(self, request, format=None):
        ...
        pedido_data = { #crea objeto para guardar en la tabla de pedidos el encabezado del pedido
                ...
                "empleadosustituto":request.data['empleadosustituto'],
